...
func (r *Racer) RunH3Race(ctx context.Context, reqSpec *models.CapturedRequest, concurrency int) ([]models.ScanResult, error) {
	...
	// Optimization: Create template request
	baseReq, _ := http.NewRequestWithContext(raceCtx, reqSpec.Method, reqSpec.URL, nil)
	baseReq.Header.Set("User-Agent", "Scalpel-Racer/Go-H3")
