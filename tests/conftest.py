...
# -- Mock 'h2' library --
# If h2 is missing, we must also mock its sub-modules to prevent AttributeErrors
...
# Essential for running tests on macOS/Windows dev machines
...
# predictable histogram data during analysis tests.
try:
    import numpy
except ImportError:
    mock_numpy = MagicMock()
    # Configure histogram to return usable dummy data (counts, bins)
    # This matches the signature expected by analysis_engine.py
