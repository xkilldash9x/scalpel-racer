# tests/test_proxy_core_refactor.py
"""
Tests for Proxy Core Refactoring and Flow Control.
"""
import asyncio
import unittest
from unittest.mock import MagicMock, AsyncMock

# [FIX] Update imports to match the new modular structure
from proxy_h2 import NativeProxyHandler

class TestProxyCoreFlowControl(unittest.IsolatedAsyncioTestCase):
    """Tests for H2 Flow Control logic."""
    async def test_stream_sender_infinite_spin_fix(self):
        ...
        self.assertFalse(flow_event.is_set(),
                         "Flow event should be cleared when window is 0")
