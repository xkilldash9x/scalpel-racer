...
class TestScalpelIntegration:
    ...
    async def test_send_probe_advanced_usage(self):
        ...
        await send_probe_advanced(
            mock_client, req, payload, barriers=[], warmup_ms=0, index=0, is_staged=False, base_headers=mock_headers
        )
        ...
        await send_probe_advanced(
            mock_client, req, payload, barriers=[], warmup_ms=100, index=0, is_staged=False, base_headers=mock_headers
        )
